...
const AccountDetail = () => {
  ...
  useEffect(() => {
    const fetchAccountDetail = async () => {
      ...
      setLoading(true);
      try {
        const response = await api.get(`/accounts/${id}/?page=${page}&limit=${limit}`);
  ...
  return (
    <div className="w-auto h-screen pl-6 pt-2">
      ...
      <div className="w-full max-h-[85%] flex flex-col lg:flex-row gap-[20px] mt-4 mb-20">
        <div className="w-[30%] rounded-[16px] border border-gray-300 p-4">
          ...
          <div className="flex flex-wrap gap-x-5 gap-y-2 w-full pt-2">
            {[
              ...
              <div key={i} className="flex flex-col w-[47%]">
