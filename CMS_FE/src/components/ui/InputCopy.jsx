...
const InputCopy = ({ value = '', showButton = true }) => {
  ...
  return (
    <div className="w-full h-[50px] bg-gray-200 flex items-center justify-between border border-gray-300 rounded-md overflow-hidden">
      <input
        type="text"
        value={value || 'No Data'}
        readOnly
        className={`p-2 outline-none bg-transparent ${showButton ? 'w-[calc(100%)]' : 'w-full'}`}
